...
<head>
    ...
    <script src="../js/fetch_button_remote.js"></script>
    ...
    <div class="container-2">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                    <form action="../controllers/set_buttontime.php" method="post" >
                                        <div class="mb-3">
        ...
        <script>
            ...
            function ShowDataDate (date) {
                ...
                fetch("../controllers/get_time_column.php", {
                    method: "POST",
                    headers: {
            ...
            function insertDate (event) {
                ...
                fetch("../controllers/set_buttontime.php", {
                    method: "POST",
                    headers: {
                        "Content-type": "application/json",
                    },
