        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../../controllers/admin/add_users.php" method="post">
                        <div class="mb-3">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form action="../../controllers/admin/update_users.php?user_id=<?=  $userID ?>" method="post">
                  <div class="mb-3">
    ...
    function confirmDelete(user_id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '../../controllers/admin/delete_users.php?user_id=' + user_id;
            }
        });
    }
