        ...
        ?> 
            <div class="card">
                ...
                <a href="../remote_control.php?device_id=<?php echo $device['device_id']; ?>">
                    <img src="../image/remote-control.png" class="card-image">
                </a>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="../Fetch_data_php/add_devices.php" method="post">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../Fetch_data_php/update_devices.php" method="post">
            <div class="mb-3">
                <label for="deviceName" class="form-label">Device Name</label>
    ...
    function confirmDelete(device_id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '../Fetch_data_php/delete_devices.php?device_id=' + device_id + '&user_id=<?php echo $user_id; ?>';
            }
        });
    }
